...
WHERE Status.STATUS_DESC = 'CREW CHANGE OVER'
   AND Haul.START_SHIFT_DATE BETWEEN '2024-01-01' AND '2024-12-01'
...
HAVING SUM(DATEDIFF(MINUTE, start_timestamp, end_timestamp)) >= 60
